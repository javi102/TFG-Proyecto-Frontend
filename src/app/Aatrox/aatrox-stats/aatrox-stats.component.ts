...
@Component({
  selector: 'app-aatrox-stats',
  templateUrl: './aatrox-stats.component.html',
  styleUrls: ['./aatrox-stats.component.css']
})
export class AatroxStatsComponent implements OnInit {
